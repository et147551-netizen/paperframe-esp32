...
//
// MEASURED, not read: every figure in docs/measurements.md was taken on this panel
// at this size. Reached through epd_geom.h, never included directly.

#ifndef EPD_GEOM_EL040EF1_H
#define EPD_GEOM_EL040EF1_H

// 2:3, portrait-native. docs/measurements.md's whole geometry table -- which source
